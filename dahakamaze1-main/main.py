...
w1 = GameSprite('platform.png',win_width/2 - win_width/3, win_height/2, 190, 50)
w2 = GameSprite('platform.png', 100, 250, 50, 300)
w3 = GameSprite('platform.png', 90, 0, 50, 150)
w4 = GameSprite('platform.png', 90, 0, 50, 150)
w5 = GameSprite('platform.png',win_width/5 - win_width/3, win_height/5, 190, 50)
w6 = GameSprite('platform.png', 300, 170, 50, 130)
...
monster1 = Enemy('shutterstock_788611123-[Converted]-49.png', win_width - 80, 180, 120, 120, 2, 420, win_width - 85)
monster2 = Enemy('shutterstock_788611123-[Converted]-49.png', win_width - 80, 100, 120, 120, 2, 100, win_width - 85)
